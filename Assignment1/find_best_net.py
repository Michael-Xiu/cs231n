...
hidden_size=[75,100,125]   #选项1 中间层的参量数
num_classes=10
results={}
best_val_acc=0
best_net=None

learning_rates=np.array([0.7,0.8,0.9,1,1.1])*1e-3  #选项2 下降的速度
regularization_strengths=[0.75,1,1.25]  #选项3 正则项大小
...
TwoLayerNN.show_net_weights(best_net)
